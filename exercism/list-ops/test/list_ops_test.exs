defmodule ListOpsTest do
  ...
  #@tag :pending
  test "concat of list of one list" do
    assert L.concat([[1, 2]]) == [1, 2]
  end

  #@tag :pending
  test "concat of list of deep list" do
    assert L.concat([[[1, 2]]]) == [1, 2]
  end

  #@tag :pending
  test "concat of list of two lists" do
    assert L.concat([[1, 2], [3, 4]]) == [1, 2, 3, 4]
  end
