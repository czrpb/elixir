defmodule BinarySearchTest do
  ...
  test "{1, 3, 5} and find each" do
    t = {1, 3, 5}
    assert BinarySearch.search(t, 3) == {:ok, 1}
    assert BinarySearch.search(t, 1) == {:ok, 0}
    assert BinarySearch.search(t, 5) == {:ok, 2}
    assert BinarySearch.search(t, 0) == :not_found
    assert BinarySearch.search(t, 2) == :not_found
    assert BinarySearch.search(t, 4) == :not_found
    assert BinarySearch.search(t, 6) == :not_found
  end
